            ...
            <div className="lg:w-9/12 space-y-4">
              ...
              <Card className=" rounded-sm">
                ...
                <div className="about p-5 text-[93.8%] text-[#6d6d6d] space-y-5">
                  ...
                  <p>
                    You can snag a hotel price guarantee and discounts at
                    Expedia by signing up for its One Key Rewards program. You
                    can also nab last-minute deals on select hotels, packages
                    and economy or premium economy flights. Plus, if you&apos;re
                    looking for savings when you book a trip on the go, the
                    Expedia mobile app can fulfill all your travel needs in one
                    seamless experience.
                  </p>
                  <p>
                    ...
                    of this page. You&apos;ll enjoy getting money back with
                    every qualifying purchase you make online!
                  </p>
                </div>
              ...
              <Card className=" rounded-sm ">
                ...
                <p className="px-5 p-3 text-[#6d6d6d] text-[14px]">
                  Please note the terms & conditions above are in addition to
                  our general{" "}
            ...
            <div className="lg:w-1/4 space-y-5 h-auto">
              ...
              <Card className="rounded-sm">
                ...
                <div className="px-5 p-3 text-[#6d6d6d] text-[14px] space-y-3">
                  <p>
                    Book with confidence, with free cancellation on select
                    hotels.
                  </p>
                  <p>
                    ...
                    and adds new benefits to help you save more and travel
                    better. One Key will offer a faster path to tier status, as
                    well as new opportunities to earn and use rewards on
                    Expedia, Hotels.com, and Vrbo. You will earn OneKeyCash for
                    all eligible travel in a booking, where the eligible travel
                    is completed on or after the date you become a One Key
                    member, including any eligible travel beforehand.
                  </p>
                </div>
              </Card>
