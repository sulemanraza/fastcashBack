...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dateJoined: Attribute.DateTime & Attribute.Required;
...
export interface ApiOfferOffer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cashbackRate: Attribute.Integer;
    ...
    retailer: Attribute.Relation<
      ...
      'api::retailer.retailer'
    >;
    offerType: Attribute.Enumeration<['cashback', 'deal', 'coupon']> &
      Attribute.Required &
      Attribute.DefaultTo<'cashback'>;
    discountType: Attribute.Enumeration<['percentage', 'fixedAmount']> &
      Attribute.Required &
...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    datePaid: Attribute.DateTime;
    method: Attribute.Enumeration<['PayPal', 'BankTransfer']> &
      Attribute.DefaultTo<'PayPal'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRetailerRetailer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    logoUrl: Attribute.Media & Attribute.Required;
    contactInfo: Attribute.Blocks;
    slug: Attribute.UID<'api::retailer.retailer', 'name'>;
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    offer: Attribute.Relation<
      ...
      'api::offer.offer'
    >;
    purchaseAmount: Attribute.Decimal;
    cashbackEarned: Attribute.Decimal;
